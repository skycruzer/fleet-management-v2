...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0;">
  <div style="background-color: #b45a3c; color: white; padding: 20px; text-align: center;">
  ...
  <div style="padding: 24px; max-width: 900px; margin: 0 auto;">
    ...
    <div style="margin-top: 24px; text-align: center;">
      <a href="${process.env.NEXT_PUBLIC_APP_URL}/dashboard/requests" style="display: inline-block; background-color: #b45a3c; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500;">
        View in Dashboard
      </a>
    </div>
  </div>
