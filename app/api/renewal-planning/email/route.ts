  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .header {
          border-bottom: 3px solid #b45a3c;
          padding-bottom: 20px;
          margin-bottom: 30px;
        }
        h1 {
    ...
    <body>
      <div class="container">
        ...
        <div class="summary-box">
          <h2 style="margin-top: 0; color: #8a3e28; font-size: 18px;">Summary Statistics</h2>
          <div class="stat">
        ...
        <h3 style="color: #8a3e28;">Roster Period Breakdown</h3>
