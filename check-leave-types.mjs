...
Object.values(grouped).forEach(item => {
  console.log(`${item.roster_period.padEnd(12)} | ${item.request_type.padEnd(20)} | Total: ${item.total}, Pending: ${item.pending}, Approved: ${item.approved}`)
})
...
Object.entries(periodSummary).sort().forEach(([period, stats]) => {
  console.log(`${period.padEnd(12)} | Total: ${stats.total}, Pending: ${stats.pending}, Approved: ${stats.approved}`)
