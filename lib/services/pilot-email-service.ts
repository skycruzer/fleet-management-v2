  ...
  try {
    ...
    const html = `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 560px; margin: 0 auto; color: #1a1a1a;">
        ...
        <a href="${dashboardLink}" style="display: inline-block; padding: 10px 20px; background-color: #b45a3c; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 500;">
          View Request
        </a>
