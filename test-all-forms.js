...
function logTest(portal, formName, action, status, details = '') {
  ...
  console.log(`${emoji} [${portal.toUpperCase()}] ${formName} - ${action}: ${status}${details ? ' - ' + details : ''}`);
}
...
async function testAdminForms(page) {
  ...
  await testButton(page, 'admin', 'Certifications List', 'a[href="/dashboard/certifications/new"]', 'Add Certification');
  ...
  if (editCertBtn) {
    ...
    if (expiryDateField) {
      ...
      logTest('admin', 'Edit Certification Form', 'Expiry date field', 'PASS', `Value: ${dateValue}`);
    } else {
      logTest('admin', 'Edit Certification Form', 'Expiry date field', 'FAIL', 'Not found');
    }

    await testButton(page, 'admin', 'Edit Certification Form', 'button[type="submit"]', 'Save Changes');
    await testButton(page, 'admin', 'Edit Certification Form', 'a[href="/dashboard/certifications"]', 'Cancel');
  }
  ...
  await testButton(page, 'admin', 'Leave Requests', 'button:has-text("Submit Leave Request")', 'Submit Leave Request');
  ...
  if (flightRequestBtn) {
    ...
    logTest('admin', 'Flight Requests', 'Button: New Flight Request', 'WARN', 'Not found or different text');
  }
...
async function testPilotForms(page) {
  ...
  await testButton(page, 'pilot', 'Leave Requests', 'a[href="/portal/leave-requests/new"]', 'Submit Leave Request');
  ...
  if (submitLeaveBtn) {
    ...
    await testButton(page, 'pilot', 'Submit Leave Request', 'button[type="submit"]', 'Submit Leave Request');
    await testButton(page, 'pilot', 'Submit Leave Request', 'a[href="/portal/leave-requests"]', 'Cancel');
  }
  ...
  await testButton(page, 'pilot', 'Flight Requests', 'a[href="/portal/flight-requests/new"]', 'Submit Flight Request');
  ...
  if (submitFlightBtn) {
    ...
    await testButton(page, 'pilot', 'Submit Flight Request', 'button[type="submit"]', 'Submit Request');
    await testButton(page, 'pilot', 'Submit Flight Request', 'a[href="/portal/flight-requests"]', 'Cancel');
  }
  ...
  await testButton(page, 'pilot', 'Leave Bids', 'a[href="/portal/leave-bids/new"]', 'Submit Leave Bid');
...
function printSummary() {
  ...
  // Print failures
  const failures = [...testResults.adminForms, ...testResults.pilotForms].filter(t => t.status === 'FAIL');
