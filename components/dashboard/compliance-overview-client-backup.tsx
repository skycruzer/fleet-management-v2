...
const mockData: ComplianceOverviewProps = {
  overallCompliance: 94.2,
  categories: [
    { name: 'Medical Certificates', current: 26, total: 27, status: 'excellent' },
    { name: 'License Renewals', current: 25, total: 27, status: 'good' },
    { name: 'Type Ratings', current: 27, total: 27, status: 'excellent' },
    { name: 'Proficiency Checks', current: 23, total: 27, status: 'warning' },
    { name: 'Simulator Training', current: 24, total: 27, status: 'good' },
  ],
  actionItems: [
    {
      id: '1',
      title: 'John Doe - Medical Certificate expires in 10 days',
      priority: 'high',
      dueDate: '2025-11-03',
    },
    {
      id: '2',
      title: 'Sarah Smith - Proficiency Check due',
      priority: 'high',
      dueDate: '2025-10-30',
    },
    {
      id: '3',
      title: 'Mike Johnson - Simulator training scheduled',
      priority: 'medium',
      dueDate: '2025-11-15',
    },
  ],
...
export function ComplianceOverview({
  overallCompliance = mockData.overallCompliance,
  categories = mockData.categories,
  actionItems = mockData.actionItems
}: Partial<ComplianceOverviewProps> = {}) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-3">
      ...
      <motion.div
        ...
        className="group relative overflow-hidden rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-lg dark:border-slate-700 dark:bg-slate-800 lg:col-span-1"
      >
      ...
      <motion.div
        ...
        className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800 lg:col-span-2"
      >
      ...
      <motion.div
        ...
        className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800 lg:col-span-3"
      >
        <div className="border-b border-slate-200 bg-danger-50 p-6 dark:border-slate-700 dark:bg-danger-900/20">
