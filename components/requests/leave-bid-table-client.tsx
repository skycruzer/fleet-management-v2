      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <Card className="border-[var(--color-status-medium-border)] bg-[var(--color-status-medium-bg)] p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-[var(--color-status-medium)]">
                Pending Review
              </p>
              <p className="text-3xl font-bold text-[var(--color-status-medium)]">
                {pendingBids.length}
              </p>
            </div>
            <div className="text-[var(--color-status-medium)]">
        ...
        <Card className="border-[var(--color-status-low-border)] bg-[var(--color-status-low-bg)] p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-[var(--color-status-low)]">Approved</p>
              <p className="text-3xl font-bold text-[var(--color-status-low)]">
                {approvedBids.length}
              </p>
            </div>
            <div className="text-[var(--color-status-low)]">
              <svg className="h-12 w-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
        ...
        <Card className="border-[var(--color-status-high-border)] bg-[var(--color-status-high-bg)] p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-[var(--color-status-high)]">Rejected</p>
              <p className="text-3xl font-bold text-[var(--color-status-high)]">
                {rejectedBids.length}
              </p>
            </div>
            <div className="text-[var(--color-status-high)]">
              <svg className="h-12 w-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
