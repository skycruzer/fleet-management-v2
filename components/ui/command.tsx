/**
 * Command Component - cmdk-based Implementation
 * Author: Maurice Rondeau
 *
 * Accessible command menu with search filtering, keyboard navigation,
 * and ARIA roles built on top of cmdk (https://cmdk.paco.me)
 */
