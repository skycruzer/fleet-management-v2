    ...
    >
      ...
      <defs>
        <linearGradient id="skyGradient" x1="60" y1="5" x2="60" y2="115">
          <stop stopColor="#c47a5a" />
          <stop offset="1" stopColor="#b45a3c" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="planeGradient" x1="25" y1="60" x2="75" y2="60">
          <stop stopColor="#b45a3c" />
          <stop offset="1" stopColor="#5a9e6f" />
        </linearGradient>
        <linearGradient id="horizonGradient" x1="5" y1="85" x2="115" y2="85">
          <stop stopColor="transparent" />
          <stop offset="0.2" stopColor="#b45a3c" stopOpacity="0.3" />
          <stop offset="0.5" stopColor="#5a9e6f" stopOpacity="0.5" />
          <stop offset="0.8" stopColor="#b45a3c" stopOpacity="0.3" />
    ...
    >
      ...
      <defs>
        <linearGradient id="pilotBgGradient" x1="60" y1="5" x2="60" y2="115">
          <stop stopColor="#b45a3c" />
          <stop offset="1" stopColor="#8a3e28" stopOpacity="0" />
        </linearGradient>
        <linearGradient id="hatGradient" x1="30" y1="40" x2="90" y2="40">
          <stop stopColor="#6b3420" />
          <stop offset="1" stopColor="#8a3e28" />
        </linearGradient>
    ...
    >
      ...
      <defs>
        ...
        <linearGradient id="certBorderGradient" x1="25" y1="25" x2="95" y2="80">
          <stop stopColor="#b45a3c" stopOpacity="0.3" />
          <stop offset="1" stopColor="#5a9e6f" stopOpacity="0.3" />
        </linearGradient>
    ...
    >
      ...
      <defs>
        <linearGradient id="searchBgGradient" x1="60" y1="5" x2="60" y2="115">
          <stop stopColor="#b45a3c" />
          <stop offset="1" stopColor="#9e4a30" stopOpacity="0" />
        </linearGradient>
    ...
    >
      ...
      <defs>
        ...
        <linearGradient id="globeGradient" x1="25" y1="25" x2="95" y2="95">
          <stop stopColor="#b45a3c" stopOpacity="0.5" />
          <stop offset="1" stopColor="#5a9e6f" stopOpacity="0.5" />
        </linearGradient>
        <linearGradient id="flightPathGradient" x1="30" y1="70" x2="90" y2="70">
          <stop stopColor="#2db87d" />
          <stop offset="0.5" stopColor="#b45a3c" />
          <stop offset="1" stopColor="#c4900a" />
        </linearGradient>
