...
-- NOTE: Removed age constraint as CURRENT_DATE is not immutable and cannot be used in CHECK constraints
-- Validation should be done at application layer instead
...
-- NOTE: Removed commencement_date constraint as CURRENT_DATE is not immutable
...
-- NOTE: Removed incident_date constraint as CURRENT_DATE is not immutable
...
-- NOTE: Removed flight_date constraint as CURRENT_DATE is not immutable
